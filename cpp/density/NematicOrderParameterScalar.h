...
#ifndef NEMATIC_ORDER_PARAMETER_SCALAR_H
#define NEMATIC_ORDER_PARAMETER_SCALAR_H
...
*/
class NematicOrderParameterScalar
    {
    public:
        //! Constructor
        NematicOrderParameterScalar(float rmax, float dr);

        //! Destructor
        ~NematicOrderParameterScalar();
    ...
    private:
        ...
        tbb::enumerable_thread_specific<float *> m_local_rdf_array;
    };

}; }; // end namespace freud::density

#endif // NEMATIC_ORDER_PARAMETER_SCALAR_H
