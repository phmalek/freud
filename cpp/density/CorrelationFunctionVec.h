...
#ifndef CORRELATION_FUNCTION_VEC_H
#define CORRELATION_FUNCTION_VEC_H
...
*/
class CorrelationFunctionVec
    {
    public:
        //! Constructor
        CorrelationFunctionVec(float rmax, float dr);

        //! Destructor
        ~CorrelationFunctionVec();
...
#endif // CORRELATION_FUNCTION_VEC_H
